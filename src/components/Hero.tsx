  ...
  return (
    <section className="bg-gradient-to-br from-blue-900 to-blue-800 text-white py-20">
      <div className="container text-center">
        <h2 className="text-5xl font-bold mb-6">¿Tienes multas prescritas?</h2>
        <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
          Carga tu certificado RMNP y descubre cuáles de tus multas de tránsito podrían estar prescritas.
          Nuestro análisis automático te mostrará si puedes solicitar la cancelación.
        </p>
