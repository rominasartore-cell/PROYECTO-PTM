  ...
  return (
    <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 py-20 text-white">
      <div className="container text-center">
        <p className="mb-4 text-sm font-black uppercase tracking-[0.25em] text-amber-300">
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg font-medium leading-8 text-blue-100 sm:text-xl">
          Sube tu certificado RMNP en PDF y obtén un resultado preliminar. Si existen multas potencialmente prescritas, podrás comprar un informe completo con borradores editables para tramitación personal.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            ...
            className="rounded-2xl bg-white px-8 py-4 font-black text-blue-950 shadow-lg transition hover:-translate-y-0.5 hover:bg-amber-50"
          >
